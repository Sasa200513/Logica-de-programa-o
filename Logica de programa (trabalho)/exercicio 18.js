...
percorrida e, em seguida, calcular quantos litros seriam necessários. Mostre
 ...
 tempoGasto = parseInt(prompt(" Digite o tempo gasto na viagem: "))
 velocidadeKm = parseInt(prompt("Digite a velocidade média durante a mesma (em Km/H): "))
 
 Litros = (tempoGasto * velocidadeKm) / 12
 
 document.write(Litros.toFixed(3))